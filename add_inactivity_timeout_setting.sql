...
INSERT INTO settings (setting_key, setting_value, setting_description, created_at, updated_at)
SELECT 'inactivity_timeout', '30', 'Auto-logout after inactivity (minutes, 0 = disabled)', NOW(), NOW()
WHERE NOT EXISTS (
