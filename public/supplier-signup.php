                        ...
                        <form id="signup-form">
                            ...
                            <div class="mb-4">
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label" for="terms-check" style="color: var(--text-secondary); font-size: 0.9rem;">
                                        I agree to the <a href="terms-privacy.php#terms" target="_blank" style="color: var(--accent); text-decoration: none;">Terms of Service</a> and <a href="terms-privacy.php#privacy" target="_blank" style="color: var(--accent); text-decoration: none;">Privacy Policy</a>
                                    </label>
                                </div>
                            </div>
                            ...
                            <div class="d-grid gap-3">
                                ...
                                <div class="text-center">
                                    <a href="simple-login.php" class="btn btn-ghost" style="color: var(--text-muted); text-decoration: none;">
